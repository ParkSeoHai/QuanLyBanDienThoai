...
create table SanPham (
    ...
    GiaBan FLOAT,
    MauSac VARCHAR2(100),
    KichThuocManHinh VARCHAR2(100),
    Ram VARCHAR2(100),
    BoNho VARCHAR2(100),
    Pin VARCHAR2(100),
    HeDieuHanh VARCHAR2(100),
    SoLuongHang VARCHAR2(100)
)
...
select Sum(DGXuat*SLXuat) from CTPhieuXuat ctpx;
...
select Sum(DGXuat*SLXuat) from PhieuXuat px, CTPhieuXuat ctpx, SanPham sp 
